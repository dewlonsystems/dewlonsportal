...
SECRET_KEY = config('SECRET_KEY', default='django-insecure-your-fallback-key-here')
...
# Custom user model? → Not needed; we use Django's built-in User

# Logging (optional but helpful for webhooks)
LOGGING = {
    'version': 1,
